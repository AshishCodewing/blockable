=== Blockable Wordpress Gutenberg Blocks ===
...
Installing "Blockable Wordpress Gutenberg Blocks" can be done either by searching for "Blockable Wordpress Gutenberg Blocks" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
